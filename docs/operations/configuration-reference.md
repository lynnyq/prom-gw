...
>
> 配套文档:[local-dev-guide.md](local-dev-guide.md)(本地部署)、[production-guide.md](production-guide.md)(生产部署)、[ruleset-reference.md](../user/ruleset-reference.md)(ruleset 字段)

## 目录

1. [启动命令行参数](#1-启动命令行参数)
2. [环境变量](#2-环境变量)
3. [Ruleset 配置文件](#3-ruleset-配置文件)
4. [Token 配置文件](#4-token-配置文件)
5. [内部模块参数](#5-内部模块参数)
6. [完整配置示例](#6-完整配置示例)
7. [参数调优速查表](#7-参数调优速查表)
...
- [Flink 消费 Kafka 写 StarRocks](flink-consumer-guide.md)
- [Ruleset 字段参考](../user/ruleset-reference.md)
...
| 参数模块 | 源码位置 |
|---|---|
| flag 定义 | [cmd/prom-gw/main.go#L57-L79](../../cmd/prom-gw/main.go) |
| env 读取 | [cmd/prom-gw/main.go#L147-L168](../../cmd/prom-gw/main.go) |
| Ruleset schema | [internal/ruleengine/types.go](../../internal/ruleengine/types.go) |
| Stage 实现 | [internal/ruleengine/stage.go](../../internal/ruleengine/stage.go) |
| Downsample | [internal/ruleengine/downsample.go](../../internal/ruleengine/downsample.go) |
| DeadValue | [internal/ruleengine/deadvalue.go](../../internal/ruleengine/deadvalue.go) |
| Token 加载 | [internal/config/token.go](../../internal/config/token.go) |
| KafkaSink 默认值 | [internal/kafkasink/producer.go#L40-L54](../../internal/kafkasink/producer.go) |
| WAL 默认值 | [internal/wal/wal.go](../../internal/wal/wal.go) |
| Sink Adapter | [internal/sink/sink.go](../../internal/sink/sink.go) |
