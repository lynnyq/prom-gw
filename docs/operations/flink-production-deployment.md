...
>
> Flink 作业的开发实现见 [Flink 消费 Kafka 写入 StarRocks 开发指南](flink-consumer-guide.md),本文档聚焦**集群部署与运维**。
>
> 配套文档:[Kafka 生产部署](kafka-production-deployment.md)、[生产部署指南](production-guide.md)、[压力测试指南](stress-test-guide.md)、[故障剧本](runbook.md)

## 目录

1. [部署架构](#1-部署架构)
2. [前置准备](#2-前置准备)
3. [Flink 集群安装](#3-flink-集群安装)
4. [JM HA 配置](#4-jm-ha-配置)
5. [集群配置详解](#5-集群配置详解)
6. [作业部署](#6-作业部署)
7. [Checkpoint 与 Savepoint](#7-checkpoint-与-savepoint)
8. [监控部署](#8-监控部署)
9. [性能调优](#9-性能调优)
10. [运维操作](#10-运维操作)
11. [附录](#11-附录)
...
- [Flink 消费 Kafka 写入 StarRocks 开发指南](flink-consumer-guide.md) — 作业开发实现
- [Kafka 生产部署](kafka-production-deployment.md) — Kafka 集群部署
- [生产部署指南](production-guide.md) — prom-gw 生产部署
- [高可用与负载均衡](ha-lb-deployment.md) — Nginx/Keepalived 部署
- [压力测试指南](stress-test-guide.md) — 性能压测
- [故障剧本](runbook.md) — 故障处理
- [配置参数说明](configuration-reference.md) — prom-gw 参数
