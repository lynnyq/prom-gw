...
> 生产部署请参考 [production-guide.md](production-guide.md)。

## 目录

1. [适用场景与拓扑](#1-适用场景与拓扑)
2. [环境准备](#2-环境准备)
3. [Kafka 单节点本地部署](#3-kafka-单节点本地部署)
4. [Prometheus 单节点本地部署](#4-prometheus-单节点本地部署)
5. [prom-gw 本地编译与配置](#5-prom-gw-本地编译与配置)
6. [全链路启动与验证](#6-全链路启动与验证)
7. [调试技巧](#7-调试技巧)
8. [常用测试场景](#8-常用测试场景)
9. [清理与重置](#9-清理与重置)
